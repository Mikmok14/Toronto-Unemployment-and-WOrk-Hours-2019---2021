...
clean_ecodat$Month<- as.character(clean_ecodat$Month)
clean_ecodat[clean_ecodat == "1"] <- "January"
clean_ecodat[clean_ecodat == "2"] <- "February"
clean_ecodat[clean_ecodat == "3"] <- "March"
clean_ecodat[clean_ecodat == "4"] <- "April"
clean_ecodat[clean_ecodat == "5"] <- "May"
clean_ecodat[clean_ecodat == "6"] <- "June"
clean_ecodat[clean_ecodat == "7"] <- "July"
clean_ecodat[clean_ecodat == "8"] <- "August"
clean_ecodat[clean_ecodat == "9"] <- "September"
clean_ecodat[clean_ecodat == "10"] <- "October"
clean_ecodat[clean_ecodat == "11"] <- "November"
clean_ecodat[clean_ecodat == "12"] <- "December"
